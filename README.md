...
- **World map** is a 1:1 recreation of the relevant Meetup Pro network page ([PyData](https://www.meetup.com/pro/pydata/), [PSF](https://www.meetup.com/pro/python-software-foundation-meetups/)) but with locations corrected.
